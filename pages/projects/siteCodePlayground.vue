    ...
    <div class="flex-grow container-fluid mx-auto w-full py-8 px-8 bg-purple-100 dark:bg-gray-900">
      ...
      <div class="mb-12">
        ...
        <div class="border border-purple-800 p-8 rounded-lg shadow-md bg-purple-200 dark:bg-gray-900">
          <h3 class="text-xl font-bold text-purple-700 dark:text-purple-300">CodePlayground</h3>
          <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">
            Ceci est un petit projet qui m'a permis de m'exercer sur le javascript et de créer un mini éditeur de code en ligne.
            j'ai vraiment pu prendre en compte les bases du javascript et de la manipulation du DOM grace à ce projet.
          </p>
        </div>
      </div>
      ...
      <div class="flex justify-between">
        <a href="https://code-playground-brown.vercel.app" target="_blank" class="bg-purple-700 text-white py-2 px-4 rounded hover:bg-purple-600">
          Voir le projet en ligne
        </a>
        <NuxtLink to="/projects/siteHijobs" class="bg-purple-700 hover:underline text-white py-2 px-4 rounded hover:bg-purple-600">
          Projet suivant
        </NuxtLink>
      </div>
    </div>
