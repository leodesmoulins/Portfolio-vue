    ...
    <div class="flex-grow container-fluid mx-auto w-full py-8 px-8 bg-purple-100 dark:bg-gray-900">
      ...
      <div class="mb-12">
        ...
        <div class="border border-purple-800 p-8 rounded-lg shadow-md bg-purple-200 dark:bg-gray-900">
          <h3 class="text-xl font-bold text-purple-700 dark:text-purple-300">Projet Pokemon Php</h3>
          <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">
            Ceci est un projet réalisé au cours de ma première année de mon BTS SIO. L'objectif était d'utiliser php avec une base de donnée Mysql.
            Avec le thème Pokemon, il fallait réaliser plusieurs fonctionnalité comment la création de compte, la connexion, Une recherche, Insertion, Modification et Suppression dans la base de donnée.
            Grâce à ce projet j'ai pu apprendre à utiliser php et Mysql. Et apprendre les bases de la programmation web avec base de données.
          </p>
          <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">
            Ce projet était en deux phase la première était réaliser la maquette en html et bootstrap.
            La deuxième phase était d'adapter le site pour php et Mysql pour le faire fonctionner avec la base de donnée.
          </p>
        </div>
      </div>
      ...
      <div class="flex justify-between">
        <NuxtLink to="/projects/siteWebFlow" class="bg-purple-700 hover:underline text-white py-2 px-4 rounded hover:bg-purple-600">
          Projet suivant
        </NuxtLink>
      </div>
    </div>
...
const imgs = [
  "/img/screen-ap3-2.PNG",
  "/img/img_pokemonPhp.PNG"
];
