    ...
    <div class="flex-grow container-fluid mx-auto w-full py-8 px-8 bg-purple-100 dark:bg-gray-900">
      ...
      <div class="mb-12">
        ...
        <div class="border border-purple-800 p-8 rounded-lg shadow-md bg-purple-200 dark:bg-gray-900">
          <h3 class="text-xl font-bold text-purple-700 dark:text-purple-300">WeClimb App</h3>
          <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">
            WeClimb est une application mobile conçue pour les amateurs d'escalade. Elle permet de trouver des salles d'escalade, de suivre ses performances, et de se connecter avec d'autres grimpeurs.
            Ce projet à été réaliser pendant un de mes stage de BTS dans l'enteprise Weclimb ou je devais travailler sur des fonctionnalié de l'application existante Weclimb.
            J'ai pu apprendre différente stack tel que Vue.js, Typescript, Json, Ionic, PostgreSQL et approfondir mes connaissances en PHP 8.
          </p>
          <p class="text-lg text-gray-700 dark:text-gray-300 mt-4">
            J'ai pu réaliser différentes fonctionnalité notamment celle de la fiche Incident, qui va permettre aux salles d'escalade de signaler un accident ou incident avec un grimpeur pour avoir un document
            pour les assurances, pompier ou familles.
          </p>
        </div>
      </div>
        ...
        <div class="border border-purple-800 p-8 rounded-lg shadow-md bg-purple-200 dark:bg-gray-900">
          <div class="flex flex-wrap justify-center space-x-4">
            <div class="flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 221"><path fill="#41b883" d="M204.8 0H256L128 220.8L0 0h97.92L128 51.2L157.44 0z"/><path fill="#41b883" d="m0 0l128 220.8L256 0h-51.2L128 132.48L50.56 0z"/><path fill="#35495e" d="M50.56 0L128 133.12L204.8 0h-47.36L128 51.2L97.92 0z"/></svg>
              <span class="text-md text-gray-700 dark:text-gray-300">Vue.js</span>
            </div>
            <div class="flex flex-col items-center">
      ...
      <div class="flex justify-between">
        <a href="https://weclimb.fr/fr" target="_blank" class="bg-purple-700 text-white py-2 px-4 rounded hover:bg-purple-600">
          Voir l'application en ligne
        </a>
        <NuxtLink to="/projects/siteCodePlayground" class="bg-purple-700 hover:underline text-white py-2 px-4 rounded hover:bg-purple-600">
          Projet suivant
        </NuxtLink>
      </div>
    </div>
...
const imgs = [
  "/img/fiche_IncidentV1.PNG",
  "/img/fiche_IncidentV2.PNG",
  "/img/groupement_salle.PNG",
  "/img/unique_salle.PNG",
