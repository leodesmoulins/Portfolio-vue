<template>
  <div class="text-center py-16">
    <p class="text-xl text-gray-700 dark:text-gray-300">Get in touch</p>
    ...
    <div class="min-h-screen py-6 flex flex-col justify-center sm:py-12">
      <div class="relative py-3 sm:max-w-4xl sm:mx-auto">
        <div
          class="absolute inset-0 bg-gradient-to-r from-purple-700 to-purple-300 dark:from-purple-300 dark:to-purple-700 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"
        ></div>
        <div
          class="text-white relative px-4 py-10 bg-purple-500 shadow-lg sm:rounded-3xl sm:p-20"
        >
          <div class="text-center pb-6">
            <h1 class="text-3xl">Un petit message pour en savoir plus ?</h1>
          </div>

          <div class="flex flex-col sm:flex-row justify-between items-start">
            <!-- Formulaire -->
            <form class="w-full sm:w-1/2" action="https://formspree.io/f/xgvogrvg" method="POST"> 
              <input
              ...
              <div class="flex justify-between">
                <input
                  class="shadow bg-purple-700 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  type="submit"
                  value="Envoyer ➤"
                />
              </div>
            ...
            <div class="w-full sm:w-1/2 mt-8 sm:mt-0 sm:ml-8">
              <h2 class="text-2xl font-bold mb-4">Informations de contact</h2>
              <p class="mb-4 text-xl">Vous pouvez également me contacter via :</p>
              <ul class="list-disc list-inside">
                <p class="text-lg">Email: leo.desmoulins@gmail.com</p>
                <p class="text-lg">Téléphone: 07 50 63 60 74</p>
              </ul>
              <h2 class="text-2xl font-bold mt-8 mb-4">Suivez-moi</h2>
