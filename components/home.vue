<template>
  <div class="text-center py-16">
    ...
    <div class="mt-8 flex flex-wrap justify-center gap-4">
      <!-- Bouton LinkedIn -->
      <a
        href="https://www.linkedin.com/in/léo-desmoulins-056039280/"
        target="_blank"
        rel="noopener noreferrer"
        class="px-8 py-4 bg-purple-700 text-white rounded-lg hover:bg-purple-800 transition duration-300 flex items-center justify-center space-x-2"
      >
      ...
      <!-- Bouton Scroll vers "À propos de moi" -->
      <button
...
const handleDownload = () => {
  ...
  link.href = "/CV Léo Desmoulins.pdf";
